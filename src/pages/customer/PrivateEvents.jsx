      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-32">
          ...
          >
            ...
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Proposal request sent! We will be in touch shortly.'); }}>
              ...
              <div className="space-y-2">
                ...
                <Input type="email" placeholder="john@example.com" className="bg-background/50 border-white/10" />
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" placeholder="20" className="bg-background/50 border-white/10" />
                </div>
              </div>
              <div className="space-y-2">
